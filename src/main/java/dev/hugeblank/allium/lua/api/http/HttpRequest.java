...
public class HttpRequest extends ChannelInitializer<SocketChannel> {
    ...
    private CompletableFuture<dev.hugeblank.allium.lua.api.http.HttpResponse> sendFuture;
    ...
    @LuaWrapped
    public CompletableFuture<dev.hugeblank.allium.lua.api.http.HttpResponse> send() {
